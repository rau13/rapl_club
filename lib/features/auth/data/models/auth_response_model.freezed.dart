...
abstract class $AuthResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, AuthData data});
...
class _$AuthResponseImpl implements _AuthResponse {
  const _$AuthResponseImpl({required this.message, required this.data});
...
class _$AuthDataImpl implements _AuthData {
  const _$AuthDataImpl({required this.token});
...
abstract class _AuthData implements AuthData {
  const factory _AuthData({required final String token}) = _$AuthDataImpl;
